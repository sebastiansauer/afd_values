...
```{r}
coeff_labels <- tibble(
  Coefficient = best_model_precis$Coefficient,
  coeff_label = c(levels(d79$state), "level1_resid", "level2_resid", "foreigner rate", "unemployment rate"))
)

coeff_labels

best_model_precis <- best_model_precis %>% 
  full_join(coeff_labels)
