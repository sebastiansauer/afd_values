...
if (nrow(stan_model_comparison_output) != 9) warning("Number of included models is incorrect!")
...
tibble::tribble(
  ...
  "m7b",        "personality",
  "m8b",        "personality without type 'unknown'"
...
#### `r icon::fa("file", size = 1)` Get slides here:  https://github.com/sebastiansauer/afd_values
